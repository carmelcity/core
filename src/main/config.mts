...
import { logger, createNodeId } from '../utils/index.mts'
...
export const makeConfig = async (): Promise<NodeConfig|undefined> => {
    ...
    switch(type) {
        case NodeType.Relay:
            ...
            return { ...base, ...relayConfig({ privateKey, peerId, ssl })} as NodeConfig
        case NodeType.Sentinel:
            return {...base, ...sentinalConfig({ privateKey })} as NodeConfig
    }
}